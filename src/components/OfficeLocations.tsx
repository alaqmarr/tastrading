            ...
            <div className="grid gap-6">
                {officesWithDistance.map((office, index) => (
                    <motion.div
                        ...
                        className={`bg-white rounded-2xl p-6 shadow-sm border-2 transition-all ${nearestOffice?.id === office.id
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <a
                                            ...
                                            className="flex items-center gap-2 px-4 py-2 bg-emerald-50 text-emerald-700 rounded-full hover:bg-emerald-100 transition-colors text-sm font-medium"
                                        >
                                            <svg
                                                className="w-4 h-4"
                                                fill="none"
