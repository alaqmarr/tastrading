...
import { offices, PRIMARY_CONTACT, getWhatsAppLink } from "@/lib/offices";
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="lg:col-span-1">
                        <Link href="/" className="flex items-center gap-3 mb-6">
                            ...
                            />
                            <div>
                                <h2 className="text-xl font-bold text-white">TAS Trading</h2>
                                <p className="text-xs text-gray-500">Corporation</p>
                            </div>
                        </Link>
                        <p className="text-sm text-gray-400 leading-relaxed mb-6">
                            Established in 1968, TAS Trading Corporation is a leading trader
                            and supplier of industrial tools and equipment in Andhra Pradesh
                            & Telangana.
                        </p>
                        <div className="flex gap-3">
                            {/* WhatsApp - Primary Contact */}
                            <a
                                href={getWhatsAppLink(PRIMARY_CONTACT.phone, "Hi, I'm interested in TAS Trading products.")}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 rounded-full bg-green-600 flex items-center justify-center hover:bg-green-500 transition-colors"
                                title={`WhatsApp ${PRIMARY_CONTACT.name}`}
                            >
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700">
                                ...
                                <p className="text-white font-medium">{PRIMARY_CONTACT.name}</p>
                                <div className="flex items-center gap-2 mt-2">
                                    ...
                                    <a
                                        href={getWhatsAppLink(PRIMARY_CONTACT.phone)}
                                        target="_blank"
                                        rel="noopener noreferrer"
                            ...
                            {offices.slice(0, 2).map((office) => (
                                <div key={office.id} className="text-sm">
                                    ...
                                    {office.contacts.map((contact) => (
                                        <p key={contact.phone} className="text-gray-400">
                                            {contact.name}:{" "}
                                            <a
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-sm text-gray-500">
                            © {currentYear} TAS Trading Corporation. All rights reserved.
                        </p>
                        <p className="text-sm text-gray-500">
