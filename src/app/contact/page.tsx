        ...
        <div className="py-16 bg-gray-50 min-h-screen">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-12">
                    ...
                    <h1 className="mt-3 text-4xl font-bold text-gray-900">Contact Us</h1>
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100">
                            ...
                            <div className="p-4">
                                ...
                                <p className="text-sm text-gray-500">Secunderabad</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100">
                            ...
                            <div className="p-4">
                                <h3 className="font-semibold text-gray-900">Balanagar Branch</h3>
                                <p className="text-sm text-gray-500">Balanagar</p>
                            </div>
                        </div>
                    </div>
                </div>
